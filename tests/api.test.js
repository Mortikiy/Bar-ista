...
describe('GET /api/getIngredients', () => {
  it('should return an array of ingredients', async () => {
    ...
    expect(response.body[0]).toHaveProperty('measurement');
  });
});
...
describe('GET /api/getAllDrinks', () => {
  it('should respond with status 200', async () => {
    const res = await request(app).get('/api/getAllDrinks');
...
describe('GET /api/getRandomDrink', () => {
  it('responds with JSON containing an array of 4 drink objects', async () => {
    ...
    res.body.forEach(drink => {
      ...
      expect(drink).toHaveProperty('glass');
      expect(drink).toHaveProperty('category');
      expect(drink).toHaveProperty('ingredients');
